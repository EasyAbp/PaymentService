...
namespace EasyAbp.PaymentService.Prepayment.Options.AccountGroups
{
    public class AccountGroupConfiguration
    {
        ...
        /// <summary>
        /// Minimum allowed account balance. It falls back to <see cref="PrepaymentConsts.AccountMinBalance"/> if null.
        /// </summary>
        public decimal? AccountMinBalance { get; set; }

        /// <summary>
        /// Maximum allowed account balance. It falls back to <see cref="PrepaymentConsts.AccountMaxBalance"/> if null.
        /// </summary>
