...
namespace PaymentServiceSample.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update PaymentServiceSampleDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update PaymentServiceSampleEfCoreEntityExtensionMappings to extend the IdentityUser entity
